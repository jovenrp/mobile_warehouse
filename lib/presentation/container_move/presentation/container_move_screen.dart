...
class _ContainerMoveScreen extends State<ContainerMoveScreen> {
  ...
  final TextEditingController destContainerNumController =
        ...
        if (containerNumTrigger) {
          ...
          if (containerNumController.text.trim().isNotEmpty == true) {
            context
                ...
                .searchContainer(
                    containerNum: containerNumController.text,
                    isDestination: false)
          ...
          if (containerToTrigger) {
            ...
            if (destContainerNumController.text.trim().isNotEmpty == true) {
              context
                  .read<ContainerMoveBloc>()
                  .searchContainer(
                      containerNum: destContainerNumController.text,
                      isDestination: true)
                  .then((List<ContainerModel> container) {
                if (container.isNotEmpty == true) {
                  context.read<ContainerMoveBloc>().moveContainer(
          ...
          child: Scaffold(
              ...
              body: Container(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Visibility(
                          visible: state.containers?.isEmpty == true &&
                              state.isInit == false,
                          child: Container(
                            padding: const EdgeInsets.only(
                          ...
                          child: ATSearchfield(
                            ...
                            onPressed: () => Navigator.push(context,
                                MaterialPageRoute<void>(
                                    builder: (BuildContext context) {
                              return QRContainerMoveScreen(
                                  scanner: 'serial', isDestination: true);
                            })).then((_) {
                                ...
                                context
                                    ...
                                    .moveContainer(
                                        ...
                                        destinationContainer: state
                                                ...
                                                true
                                            ? state
                                                .containersDestination?.first.id
                                            : '')
                                    .then((_) {
                            ...
                            onFieldSubmitted: (String? value) {
                              context
                                  .read<ContainerMoveBloc>()
                                  .searchContainer(
                                      containerNum: value, isDestination: true)
                                  .then((List<ContainerModel> container) {
                                context
                                    .read<ContainerMoveBloc>()
                                    .moveContainer(
                                        ...
                                        children: <TableRow>[
                                          TableRow(
                                              decoration: BoxDecoration(
                                                  color:
                                                      AppColors.beachSeaTint40),
                                              children: <Widget>[
                                                Container(
                                                  color:
                                                      AppColors.beachSeaTint20,
                                                  padding:
                        ...
                        Visibility(
                            visible:
                                state.containersDestination?.isNotEmpty == true,
                            child: Container(
