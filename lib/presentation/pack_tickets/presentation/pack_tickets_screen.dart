...
class PackTicketsScreen extends StatefulWidget {
  const PackTicketsScreen({Key? key}) : super(key: key);
...
class _PackTicketsScreen extends State<PackTicketsScreen> {
  ...
  void initState() {
    super.initState();
    context.read<PackTicketsBloc>().getPackTickets();
