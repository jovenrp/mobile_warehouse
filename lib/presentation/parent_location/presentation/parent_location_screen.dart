...
class _ParentLocationScreen extends State<ParentLocationScreen> {
              ...
              onTap: () {
                if (state.containerModel?[0].isRoot?.toLowerCase() == 'y') {
                  ...
                  Navigator.of(context).push(ParentLocationScreen.route(
                      parentId:
                          (int.parse(state.containerModel?[0].parentId ?? ''))
                              .toString(),
                      navigation: 'pop',
                                    ...
                                    builder: (BuildContext context) {
                                      return StatefulBuilder(builder:
                                          (BuildContext context,
                                              StateSetter state) {
                                        return parentContainer?.isNotEmpty ==
                                                true
                                            ? addChild(parentContainer?.first,
                                                isDialogueError, state)
  ...
  Widget addChild(
      ContainerModel? containerModel, bool isError, StateSetter setState) {
