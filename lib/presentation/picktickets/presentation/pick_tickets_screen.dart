...
class _PickTicketsScreen extends State<PickTicketsScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<PickTicketsBloc, PickTicketsState>(listener: (BuildContext context, PickTicketsState state) {
      if (!state.isLoading) {
                      ...
                      child: ATSearchfield(
                          ...
                          onPressed: () {
                            if (searchController.text.isNotEmpty == true) {
                              setState(() {
                                context.read<PickTicketsBloc>().searchTicket(value: searchController.text);
                              });
                            }
                          },
                                          ...
                                          TableRow(children: <Widget>[
                                            Ink(
                                              ...
                                              onTap: () {
                                                context
                                                    ...
                                                    .sortPickTicket(pickTicket: state.pickTicketsItemModel, column: 'status', sortBy: isStatusSort);
                                                setState(() {
                                              ...
                                              child: InkWell(
                                                onTap: () {
                                                  context.read<PickTicketsBloc>().sortPickTicket(
                                                      pickTicket: state.pickTicketsItemModel, column: 'ticketNumber', sortBy: isTicketNumberSort);
                                                  setState(() {
                                            ...
                                            Ink(
                                              child: InkWell(
                                                onTap: () {
                                                  context.read<PickTicketsBloc>().sortPickTicket(
                                                      pickTicket: state.pickTicketsItemModel, column: 'destination', sortBy: isDestinationSort);
                                                  setState(() {
                                            ...
                                            Ink(
                                              child: InkWell(
                                                onTap: () {
                                                  context.read<PickTicketsBloc>().sortPickTicket(
                                                      pickTicket: state.pickTicketsItemModel, column: 'numLines', sortBy: isNumLineSort);
                                                  setState(() {
                                            ...
                                            children: <TableRow>[
                                              TableRow(
                                                  ...
                                                  children: <Widget>[
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: PickTicketsStatusWidget(
                                                          status: state.pickTicketsItemModel?[index].status,
                                                          turns: turns,
                                                        ),
                                                      ),
                                                    ),
                                                    Container(
                                                      child: ATText(
                                                        text: state.pickTicketsItemModel?[index].num ?? '',
                                                        fontSize: 15,
                                                      ),
                                                    ),
                                                    Container(
                                                      child: ATText(
                                                        text: state.pickTicketsItemModel?[index].destination ?? '',
                                                        fontSize: 15,
                                                      ),
                                                    ),
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        alignment: Alignment.centerRight,
                                                        child: ATText(
                                                          text: state.pickTicketsItemModel?[index].numLines ?? '',
                                                          fontSize: 15,
                                                        ),
                                                      ),
                                                    ),
