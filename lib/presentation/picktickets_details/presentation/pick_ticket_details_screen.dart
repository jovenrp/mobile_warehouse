                                                              ...
                                                              children: <
                                                                ...
                                                                Expanded(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        ATText(
                                                                      text: state.pickTicketsResponse?[index].status?.toLowerCase() == 'partial' ? '${state.pickTicketsResponse?[index].qtyPicked} of ${state.pickTicketsResponse?[index].qtyPick}' : (state.pickTicketsResponse?[index].pickedItem == null ||
