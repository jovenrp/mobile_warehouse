    ...
    return BlocConsumer<PickTicketDetailsBloc, PickTicketDetailsState>(listener: (BuildContext context, PickTicketDetailsState state) {
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: ATTextButton(
                              ...
                              onTap: () {
                                currentIndex = -1;
                                context.read<PickTicketDetailsBloc>().exitPick(pickTicketDetailId: state.dummyPickTicketDetailsModel?.id ?? '');
      ...
      return WillPopScope(
          ...
          child: SafeArea(
              child: Scaffold(
            appBar: ATAppBar(
              title: '${widget.ticketItemModel?.num} - ${widget.ticketItemModel?.destination}'.capitalizeFirstofEach(),
              icon: Icon(
