...
class _QRStockAdjustScreen extends State<QRStockAdjustScreen> {
  Barcode? result;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            body: BlocConsumer<StockAdjustBloc, StockAdjustState>(
          ...
          context.read<StockAdjustBloc>().stockLookUp(locNum: widget.location, sku: result?.code)
            ...
            Future<void>.delayed(Duration.zero, () {
              Navigator.of(context)
                  .popUntil(ModalRoute.withName('/stockAdjust'));
            });
          });
