                    ...
                    Visibility(
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              Visibility(
                                  visible: state.receiveTicketsModel?.isNotEmpty == true,
                                  child:
                            ...
                            ? state.receiveTicketsModel?.isNotEmpty == true
                                ? SmartRefresher(
                                    ...
                                    child: ListView.builder(
                                        itemCount: state.receiveTicketsModel?.length ?? 0,
                                                ...
                                                children: <TableRow>[
                                                  TableRow(
                                                      ...
                                                      children: <Widget>[
                                                        Padding(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: PickTicketsStatusWidget(
                                                              status: state.receiveTicketsModel?[index].status,
                                                              isPartial: state.receiveTicketsModel?[index].isPartial,
                                                              turns: turns,
                                                            ),
                                                          ),
                                                        ),
                                                        Container(
                                                          child: ATText(
                                                            text: state.receiveTicketsModel?[index].num,
                                                            fontSize: 15,
                                                          ),
                                                        ),
                                                        Container(
                                                          child: ATText(
                                                            text: state.receiveTicketsModel?[index].vendorName,
                                                            fontSize: 15,
                                                          ),
                                                        ),
                                                        Padding(
                                                          ...
                                                          child: Container(
                                                            alignment: Alignment.centerRight,
                                                            child: ATText(
                                                              text: state.receiveTicketsModel?[index].numLines,
                                                              fontSize: 15,
                                                            ),
                                                          ),
                                                        ),
                                                  ...
                                                  TableRow(
                                                      ...
                                                      children: <Widget>[
                                                        SizedBox(),
                                                        SizedBox(),
                                                        state.receiveTicketsModel?[index].status?.toLowerCase() == 'processing'
                                                            ? Container(
                                                                padding: const EdgeInsets.only(left: 10, bottom: 15),
                                                                child: ATText(
                                                                  text: 'processing by ${state.receiveTicketsModel?[index].fullName}',
                                                                  fontSize: 13,
                                                                ),
                                                              )
                                                            : SizedBox(),
