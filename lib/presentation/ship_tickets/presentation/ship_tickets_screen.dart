...
class ShipTicketsScreen extends StatefulWidget {
  const ShipTicketsScreen({Key? key}) : super(key: key);
  ...
  @override
  _ShipTicketsScreen createState() => _ShipTicketsScreen();
}

class _ShipTicketsScreen extends State<ShipTicketsScreen> {
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                        child: !state.isLoading
                            ? state.shipTicketsModel?.isNotEmpty == true
                                ? SmartRefresher(
