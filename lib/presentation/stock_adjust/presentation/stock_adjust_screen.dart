                  ...
                  child: ATSearchfield(
                    ...
                    onFieldSubmitted: (String? value) {
                      context.read<StockAdjustBloc>().lookupItemAlias(item: searchController.text).then((List<ItemAliasModel>? itemAlias) {
                        ...
                        context.read<StockAdjustBloc>().lookupBarcodeStock(item: itemAlias?.first.itemId).then((value) => isInit = false);
                                    ...
                                    Flexible(
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            ...
                                            if (!isInit) {
                                              qtyControllers[index].text = state.itemStock?[index].qty ?? '0';
                                              if (index == state.itemStock!.length - 1) {
                                                isInit = true;
                                              }
                                            }
                                            return Table(
                                                  ...
                                                  TableRow(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: ATText(text: state.itemStock?[index].uom, fontSize: 14, fontColor: AppColors.white),
                                                        ),
                                                      ]),
                                                  TableRow(
                                                      decoration:
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            children: <Widget>[
                                                              ...
                                                              ATText(text: ' (minus to subtract)', fontSize: 12, style: TextStyle(fontStyle: FontStyle.italic, color: AppColors.white)),
                                                            ],
                                                          ),
                                                        ),
                                                      ]),
                                                            ...
                                                            child: ATTextfield(
                                                              ...
                                                              onFieldSubmitted: (String? value) {
                                                                context
                                                                    ...
                                                                    .stockAdjust(absolute: true, stockId: state.itemStock?[index].id, qty: value).then((List<StockAdjustModel>? stockModel) {
                                                                  setState(() {
                                                        ...
                                                        Padding(
                                                            ...
                                                            child: ATTextfield(
                                                                ...
                                                                onFieldSubmitted: (String? value) {
                                                                  context
                                                                      .read<StockAdjustBloc>()
                                                                      .stockAdjust(absolute: false, stockId: state.itemStock?[index].id, qty: value).then((List<StockAdjustModel>? stockModel) {
                                                                    setState(() {
                                                                      qtyControllers[index].text = stockModel?.first.qty ?? '0';
